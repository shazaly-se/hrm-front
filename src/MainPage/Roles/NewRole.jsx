...
const NewRole = () => {
    ...
    useEffect(() => {
      //let id = params.id
      axios.get(baseUrl+"role-permissions")
      .then(res => {
    ...
    function handleSubmit (event) {
     ...
     const data = {role:roleName,permissions: selected}
     if(selected.length <=0){
      ...
      axios.post(baseUrl+"role-permissions", data)
        .then(res => {
          if(res.data.success){
          ...
          history.push("/app/employee/roles-list")
            ...
            setHasError(true)
            setErrorMessage("This Role Alreay Exist")
          }
    ...
    function deleteDepartmnet (e) {
     ...
     const onRemove = (selectedList, removedItem)=> {
      ...
      <div className="content container-fluid">
        ...
        <input name="roleName" value={roleName} onChange={handleChange} className="form-control" />
        </div>
      ...
      <div className='m-3'>
      <a className="btn btn-primary m-1" onClick={handleSubmit}><i className="fa fa-save m-r-5" />Create Role</a>
      </div>
