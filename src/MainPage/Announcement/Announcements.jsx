       ...
       },
       {
         ...
         render: (text, record) => (
             <div className="dropdown dropdown-action text-end">
               <Link className="btn btn-primary m-1"  to={"/app/employee/announcement/"+record.id}><i className="fa fa-pencil m-r-5" /> </Link>
                 ...
                 <div className="page-header">
                   <div className="row align-items-center">
                     ...
                     <div className="col-auto float-end ml-auto">
                       <Link to={"/app/employee/new-announcement"} className="btn add-btn" ><i className="fa fa-plus" /> New Announcement </Link>
                     </div>
                   </div>
                 </div>
                 {/* /Page Header */}
