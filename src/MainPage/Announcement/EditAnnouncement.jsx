...
const EditAnnouncement = () => {
    ...
    const [announcement, setAnnouncement] = useState({
     ...
     useEffect(() => {
        let id = params.id
        axios.get(baseUrl+"announcements/"+id,{
          headers: {
        ...
        .then(res => {
            console.log("next",res.data.departments)
          setType_id(res.data.announcements.type_id)
          setType_name(res.data.announcements.type_name)
          setDescription(res.data.announcements.description)
          setSelected(res.data.departments)
        })
    ...
    function handleSubmit (event) {
      ...
      axios.put(baseUrl+"announcements/"+id,data)
      .then(res =>{
        Swal.fire(
          'Success!',
           'Successfully Sent!',
...
<label>Departments: </label>
      ...
      <textarea  rows="5" onChange={handleDescription} value={description}></textarea>
       </div>
      <div className='m-3'>
